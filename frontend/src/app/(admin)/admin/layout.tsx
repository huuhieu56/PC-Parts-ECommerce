...
const adminNavItems: NavItem[] = [
  ...
  { href: "/admin/suppliers", label: "Nhà cung cấp", icon: Factory, permission: Permission.INVENTORY_MANAGE },
  { href: "/admin/coupons", label: "Mã giảm giá", icon: Tag, permission: Permission.COUPON_VIEW },
