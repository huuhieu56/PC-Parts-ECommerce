...
| TC-AUTH-35 | Thêm địa chỉ mới                        | Customer đã đăng nhập                     | 1. POST /addresses với đầy đủ thông tin                                   | Trả 201, Address tạo thành công                               | P    |
| TC-AUTH-36 | Thêm địa chỉ — thiếu trường bắt buộc    | Customer đã đăng nhập                     | 1. POST /addresses thiếu province                                         | Trả 400, validation error                                     | N    |
| TC-AUTH-37 | Sửa địa chỉ                             | Address id=1 thuộc user                   | 1. PUT /addresses/1 với street mới                                        | Trả 200, Address cập nhật                                     | P    |
| TC-AUTH-38 | Đặt địa chỉ mặc định                    | User có ≥ 2 Address                       | 1. PATCH /addresses/2/default                                             | Trả 200, Address 2 default=true, Address cũ default=false     | P    |
| TC-AUTH-39 | Xóa địa chỉ duy nhất                    | User chỉ có 1 Address (mặc định)          | 1. DELETE /addresses/1                                                    | Trả 400, "Bạn cần tạo địa chỉ mới trước khi xóa"              | N    |
...
| TC-ORD-15 | Hủy đơn — trạng thái không cho phép  | Order status=COMPLETED                     | 1. POST /orders/1/cancel                                       | Trả 400, "Không thể hủy đơn đã hoàn thành"                   | N    |
| TC-ORD-16 | Checkout giỏ hàng trống              | Cart không có item                         | 1. POST /orders                                                | Trả 400, "Giỏ hàng trống"                                    | N    |
| TC-ORD-17 | Checkout không có địa chỉ            | Không có Address nào                       | 1. POST /orders không có address_id                            | Trả 400, "Vui lòng chọn địa chỉ giao hàng"                  | N    |
| TC-ORD-18 | Xem chi tiết đơn của người khác      | Order thuộc User A, User B đăng nhập       | 1. GET /orders/1                                                | Trả 403 hoặc 404                                             | N    |
