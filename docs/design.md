...
| TC-AUTH-11 | Đổi mật khẩu thành công                 | Customer đã đăng nhập                     | 1. POST /auth/change-password với oldPwd đúng, newPwd hợp lệ             | Trả 200, password_hash cập nhật                                | P    |
| TC-AUTH-12 | Đổi mật khẩu — mật khẩu cũ sai          | Customer đã đăng nhập                     | 1. POST /auth/change-password với oldPwd sai                              | Trả 400, "Mật khẩu hiện tại không chính xác"                   | N    |
| TC-AUTH-13 | Đổi mật khẩu — mật khẩu mới trùng cũ    | Customer đã đăng nhập                     | 1. POST /auth/change-password với newPwd = oldPwd                         | Trả 400, "Mật khẩu mới phải khác mật khẩu cũ"                 | N    |
| TC-AUTH-14 | Đổi mật khẩu — xác nhận không khớp      | Customer đã đăng nhập                     | 1. POST /auth/change-password với newPwd ≠ confirmPwd                     | Trả 400, "Mật khẩu xác nhận không khớp"                       | N    |
