...
Hệ thống cần lưu trữ và xử lý 35 thực thể (Entities) chính, được nhóm theo nghiệp vụ:
...
* ***Nhóm Nội dung:***  
  * Banner / Slider (Banner): *Tiêu đề, hình ảnh (MinIO), URL liên kết, thứ tự hiển thị, ngày bắt đầu, ngày kết thúc, trạng thái (Active/Inactive).*
